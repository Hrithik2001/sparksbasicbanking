  ...
  ?>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  ...
                  <marquee direction="right"><h1>RUPAIAH BANK</h1></marquee>
                </div>
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    <img src="img/transfer.jfif" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>Copyright <b>MALLAPURAM SAI HRITHIK</b>  &copy 2021<br> The Sparks Foundation</p>
      </footer>
